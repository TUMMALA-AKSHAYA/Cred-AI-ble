  ...
  return (
    <QuizProvider>
      <div className={darkMode ? 'dark' : ''}>
        {/* Dark Mode Toggle - Moved to Bottom Right for Better Visibility */}
        <button
          onClick={() => setDarkMode(!darkMode)}
          className="fixed bottom-8 right-8 z-50 p-4 rounded-2xl bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 transition-all duration-300 shadow-2xl hover:shadow-3xl hover:scale-110 border-2 border-gray-200 dark:border-gray-600"
