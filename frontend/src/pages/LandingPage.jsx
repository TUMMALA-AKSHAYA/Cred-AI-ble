    ...
    <div className="min-h-screen bg-gradient-to-b from-white to-gray-50">
      ...
      <section className="relative w-full py-20 md:py-32 overflow-hidden">
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div className="absolute bottom-20 right-1/3 w-80 h-80 bg-violet-500/5 rounded-full blur-3xl"></div>
        </div>
        ...
        <Container className="relative z-10">
          <div className="max-w-4xl">
            ...
            {/* Subheadline */}
            <p className="text-xl md:text-2xl text-gray-600 leading-relaxed max-w-2xl mb-8 font-light">
            ...
            {/* Social Proof */}
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-8 pt-8 border-t border-gray-200">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-medium text-gray-600">2,847 students enrolled</span>
              </div>
              <span className="text-sm text-gray-400">•</span>
              <span className="text-sm font-medium text-gray-600">⭐ 4.9/5 average rating</span>
              <span className="text-sm text-gray-400">•</span>
              <span className="text-sm font-medium text-gray-600">🔗 1,200+ credentials minted</span>
            </div>
          </div>
        </Container>
      </section>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <Card key={idx} variant="default">
                <div className="text-4xl font-bold text-indigo-600 mb-4">{item.number}</div>
